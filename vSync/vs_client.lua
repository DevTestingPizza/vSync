...
TriggerEvent('chat:addSuggestion', '/weather weathertype', 'Valid weather types are: extrasunny, clear, neutral, smog, foggy, overcast, clouds, clearing, rain, thunder, snow, blizzard, snowlight, xmas & halloween.')
TriggerEvent('chat:addSuggestion', '/time hh mm', 'Change the time!')
